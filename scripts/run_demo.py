#!/usr/bin/env python3
"""Tiny end-to-end demo: dataset → train → evaluate → optimize → report."""
...
from tps_surrogate.pipeline import run_pipeline  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run the small end-to-end demo.")
    ...
    print(f"Demo complete. Outputs in {out}")
    return 0
